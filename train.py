...
class Trainer:
	def __init__(self):
		...
		self.test_data = {'games_played': [], 'zero_vs_random': [], 'zero_vs_mcts100': [], 'zero_vs_mcts200': [], 'net_vs_random': [], 'net_vs_mcts100': [], 'net_vs_mcts200': []}
	...
	def train_network(self, n_batches):
		...
		for i in range(n_batches):
			...
			loss_tot_v += loss_v
			if i % 200 == 0:
				print("Batch: " + str(i) + "Loss policy: " + str(loss_tot_p/200.) + "Loss value: " + str(loss_tot_v/200.))
				loss_tot_v = 0
				loss_tot_p = 0
